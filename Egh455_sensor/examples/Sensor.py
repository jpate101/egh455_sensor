...
while True:
    ...
    # rs/ro match graph
    readings.reducing = math.pow(10, -1.25 * math.log10(readings.reducing/158115.24) + 0.64) 
    readings.oxidising = math.pow(10, math.log10(readings.oxidising/3344) - 0.8129)
    readings.nh3 = math.pow(10, -1.8 * math.log10(readings.nh3/58920) - 0.163)
